...
OUTPUT_DIR = "../results/EfficientNetV2B0_har"
...
def build_model(model_name, num_classes):
    if model_name == "EfficientNetV2B0":
        ...
        preprocess_func = effv2_preprocess
...
# --- MAIN TRAINING LOOP ---
models_to_train = ["EfficientNetV2B0"]
final_results = []
...
results_df.to_csv(os.path.join(OUTPUT_DIR, "efficientnetv2_results.csv"), index=False)
