...
# --- CONFIGURATION ---
BASE_PATH = "../dataset"  # Assuming dataset is in a 'dataset' folder outside 'scripts'
TRAIN_IMG_DIR = os.path.join(BASE_PATH, "train")
TRAIN_CSV = os.path.join(BASE_PATH, "Training_set.csv")
OUTPUT_DIR = "../results/EfficientNetB0_har"
...
results_df.to_csv(os.path.join(OUTPUT_DIR, "efficientnet_results.csv"), index=False)
